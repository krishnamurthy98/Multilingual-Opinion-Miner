...
app.layout = html.Div([
    ...
    html.H1('Multilingual Opinion Miner', style={'font-family': 'nasalization',
...
image_directory = '/Users/krishnamurthy/Multilingual-Sentiment-Analysis/'
index_page = html.Div([
    html.Fieldset([dcc.Link(html.Img(id='image_1',src='/static/keyword_search_image.png',
                   alt="no_image", style={'height': '300px', 'width': '500px',
                   'transition': '0.3s', 'border-radius': '5px'}), href='/keywords_home'), html.Hr(),
                   html.P("Allows you to get the pulse on the basis of keywords specified")], style={'display': 'inline-block', 'border' : 'solid 1px black', 'padding' : '1% 1% 0% 1%', 'margin': '3.5%', 'border-radius': '5px'}, dir='ltr')],
    #html.Br(),
